...
public interface AttributionUtilisateurBadgeServiceORM {
    ...
    public List<AttributionUtilisateurBadge> getByBadge(Badge badge, int debut, int nbResult);

    public List<AttributionUtilisateurBadge> getByBadge(Badge badge);

    public List<AttributionUtilisateurBadge> getByUtilisateur(Utilisateur utilisateur, int debut, int nbResult);

    public List<AttributionUtilisateurBadge> getByUtilisateur(Utilisateur utilisateur);
